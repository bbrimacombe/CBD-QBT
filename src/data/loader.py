    ...
    for lang in params.mono_dataset.keys():
        ...
        for splt in ['train', 'valid', 'test']:
            ...
            if lang in params.ae_steps or lang in params.bt_src_langs \
                or lang in params.encoder_bt_src_langs or lang in params.qbt_src_langs:
                ### Change to langs version????
                #was encoder_bt_steps, qbt_steps
...
def check_data_params(params):
    ...
    required_mono = set([l1 for l1, l2 in (params.mlm_steps + params.clm_steps) if l2 is None] + params.ae_steps + params.bt_src_langs + params.encoder_bt_src_langs + params.qbt_src_langs)
    params.mono_dataset = {
        lang: {
