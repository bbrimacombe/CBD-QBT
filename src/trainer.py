...
class Trainer(object):
    ...
    def encoder_bt_step(self, lang1, lang2, lang3, lambda_coeff):
        ...
        if (self.cnt % 256 == 0) or (self.cnt % 257 == 0):
            x_to_text = convert_to_text(x, lengths, self.data['dico'], params)[:5]
        else:
            x_to_text = None
        """
        ...
        try:
            with torch.no_grad():
                ...
                #
                x2, len2 = _encoder.generate(src_enc=None, src_len=None, tgt_lang_id=None, enc_dict=enc_dict, sample_temperature=0.9)
...
class EncDecTrainer(Trainer):
    ...
    def qbt_step(self, lang1, lang2, lang3, lambda_coeff):
        ...
        try:
            ...
            # decode original sentence
            dec3 = _decoder('fwd', x=x, lengths=lengths, langs=langs1, causal=True, src_enc=enc2, src_len=len2)
